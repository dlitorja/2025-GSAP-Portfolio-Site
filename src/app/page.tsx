            ...
            <ScrollStagger staggerDelay={0.1}>
              <div className="grid gap-8 md:grid-cols-2">
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="group relative overflow-hidden rounded-lg border border-border bg-card hover:shadow-xl transition-all duration-300 hover:scale-[1.02]"
                  >
            ...
            <ScrollStagger staggerDelay={0.15}>
              <div className="space-y-6">
                ...
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="group border border-border rounded-lg p-6 hover:shadow-xl transition-all duration-300 hover:scale-[1.01]"
                  >
